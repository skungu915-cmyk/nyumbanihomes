...
const TENANTS = [
  ...
  {initials:"PN",color:"#E8622A",bg:"#FFF4EE",name:"Peter Njoroge",unit:"Unit 2C, Kileleshwa",phone:"+254 700 777 888",since:"Aug 2023",rent:35000,status:"paid",lease:"31 Jul 2026"},
  ...
  {initials:"DM",color:"#1A2332",bg:"#FFF4EE",name:"David Mutua",unit:"Unit 11, Runda",phone:"+254 733 889 000",since:"Sep 2024",rent:180000,status:"paid",lease:"31 Aug 2026"},
];
...
function updateActiveFilters(loc, type, budget, amenity, county) {
  ...
  container.innerHTML = tags.map((t,i) => `
    <div style="display:inline-flex;align-items:center;gap:6px;background:#FFF4EE;color:#E8622A;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;cursor:pointer" onclick="clearFilterTag(${i})">
...
function handleVideoUpload(input) {
  ...
  valid.forEach(file => {
    ...
    const div = document.createElement('div');
    div.style.cssText = 'position:relative;border-radius:8px;overflow:hidden;border:1px solid #F4A468;background:#0D1520';
    div.innerHTML = `
      <video src="${url}" style="width:180px;height:100px;object-fit:cover;display:block" controls muted></video>
      <div style="font-size:11px;color:#F4A468;padding:4px 8px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:180px">${file.name}</div>
